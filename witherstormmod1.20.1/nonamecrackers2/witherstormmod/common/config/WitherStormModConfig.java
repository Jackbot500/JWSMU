...
/*     */   
/*     */   static {
/*  32 */     Pair<ClientConfig, ForgeConfigSpec> clientSpecPair = (new ForgeConfigSpec.Builder()).configure(ClientConfig::new);
/*  33 */     CLIENT_SPEC = (ForgeConfigSpec)clientSpecPair.getRight();
/*  34 */     CLIENT = (ClientConfig)clientSpecPair.getLeft();
/*  35 */     Pair<CommonConfig, ForgeConfigSpec> commonSpecPair = (new ForgeConfigSpec.Builder()).configure(CommonConfig::new);
/*  36 */     COMMON_SPEC = (ForgeConfigSpec)commonSpecPair.getRight();
/*  37 */     COMMON = (CommonConfig)commonSpecPair.getLeft();
/*  38 */     Pair<ServerConfig, ForgeConfigSpec> serverSpecPair = (new ForgeConfigSpec.Builder()).configure(ServerConfig::new);
/*  39 */     SERVER_SPEC = (ForgeConfigSpec)serverSpecPair.getRight();
/*  40 */     SERVER = (ServerConfig)serverSpecPair.getLeft();
/*     */   }
/*     */ 
/*     */   
/*     */   public static void registerPresets(RegisterConfigPresetsEvent event) {
/*  45 */     event.exclude(CLIENT.playWitherStormTheme)
/*  46 */       .exclude(CLIENT.playSymbiontTheme)
/*  47 */       .exclude(CLIENT.chromaticAberration)
/*  48 */       .exclude(CLIENT.blindingEffects)
/*  49 */       .exclude(CLIENT.cameraShakeEffects)
/*  50 */       .exclude(CLIENT.distantFog)
/*  51 */       .exclude(CLIENT.earRingingEffects)
/*  52 */       .exclude(CLIENT.renderTractorBeamOverlay)
/*  53 */       .exclude(CLIENT.renderSkyAmbienceEffects)
/*  54 */       .exclude(CLIENT.tractorBeamParticles)
/*  55 */       .exclude(CLIENT.renderShine)
/*  56 */       .exclude(CLIENT.distantRenderer)
/*  57 */       .exclude(CLIENT.witherSicknessLayer)
/*  58 */       .exclude(CLIENT.vertexBufferRendering)
/*  59 */       .exclude(CLIENT.optifineWarning)
/*  60 */       .exclude(CLIENT.aprilFools)
/*  61 */       .exclude(CLIENT.patronCosmetic)
/*  62 */       .exclude(CLIENT.customPanorama)
/*  63 */       .exclude(CLIENT.asyncBufferBuilders)
/*  64 */       .exclude(CLIENT.hideDebrisRingsUntilSplit)
/*  65 */       .exclude(CLIENT.playMinecraftMusic);
/*     */     
/*  67 */     event.registerPreset(ModConfig.Type.CLIENT, ConfigPreset.builder((Component)Component.m_237115_("config.witherstormmod.preset.client.medium.title"))
/*  68 */         .setPreset(CLIENT.renderDebrisCloud, Boolean.valueOf(false))
/*  69 */         .setPreset(CLIENT.tractorBeamParticles, Boolean.valueOf(false))
/*  70 */         .setPreset(CLIENT.lowResModels, Boolean.valueOf(false))
/*  71 */         .setPreset(CLIENT.witherStormLOD, Boolean.valueOf(false))
/*  72 */         .setPreset(CLIENT.blockClusterRendering, Boolean.valueOf(true))
/*  73 */         .setDescription((Component)Component.m_237115_("config.witherstormmod.preset.client.medium.description")).build());
/*     */     
/*  75 */     event.registerPreset(ModConfig.Type.CLIENT, ConfigPreset.builder((Component)Component.m_237115_("config.witherstormmod.preset.client.low.title"))
/*  76 */         .setPreset(CLIENT.renderDebrisCloud, Boolean.valueOf(false))
/*  77 */         .setPreset(CLIENT.tractorBeamParticles, Boolean.valueOf(false))
/*  78 */         .setPreset(CLIENT.lowResModels, Boolean.valueOf(false))
/*  79 */         .setPreset(CLIENT.witherStormLOD, Boolean.valueOf(true))
/*  80 */         .setPreset(CLIENT.blockClusterRendering, Boolean.valueOf(false))
/*  81 */         .setDescription((Component)Component.m_237115_("config.witherstormmod.preset.client.low.description")).build());
/*     */     
/*  83 */     event.registerPreset(ModConfig.Type.CLIENT, ConfigPreset.builder((Component)Component.m_237115_("config.witherstormmod.preset.client.ultra_low.title"))
/*  84 */         .setPreset(CLIENT.renderDebrisCloud, Boolean.valueOf(false))
/*  85 */         .setPreset(CLIENT.tractorBeamParticles, Boolean.valueOf(false))
/*  86 */         .setPreset(CLIENT.lowResModels, Boolean.valueOf(true))
/*  87 */         .setPreset(CLIENT.witherStormLOD, Boolean.valueOf(false))
/*  88 */         .setPreset(CLIENT.blockClusterRendering, Boolean.valueOf(false))
/*  89 */         .setDescription((Component)Component.m_237115_("config.witherstormmod.preset.client.ultra_low.description")).build());
/*     */ 
/*     */     
/*  92 */     event.registerPreset(ModConfig.Type.SERVER, ConfigPreset.builder((Component)Component.m_237115_("config.witherstormmod.preset.server.performance.title"))
/*  93 */         .setPreset(SERVER.squashHitbox, Boolean.valueOf(true))
/*  94 */         .setDescription((Component)Component.m_237115_("config.witherstormmod.preset.server.performance.description")).build());
/*     */     
/*  96 */     event.registerPreset(ModConfig.Type.SERVER, ConfigPreset.builder((Component)Component.m_237115_("config.witherstormmod.preset.server.mass_destruction.title"))
/*  97 */         .setPreset(SERVER.hunchbackClusterPickupInterval, Integer.valueOf(10))
/*  98 */         .setPreset(SERVER.clusterPickupInterval, Integer.valueOf(10))
/*  99 */         .setPreset(SERVER.devourerClusterPickupInterval, Integer.valueOf(10))
/* 100 */         .setPreset(SERVER.flamingSkullExplosionSize, Double.valueOf(12.0D))
/* 101 */         .setPreset(SERVER.flamingSkullSpeedModifier, Double.valueOf(4.0D))
/* 102 */         .setDescription((Component)Component.m_237115_("config.witherstormmod.preset.server.mass_destruction.description")).build());
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Jackbot\Desktop\Jacks Crackers Wither Storm Update\witherstormmod-1.20.1-4.2.1-all.jar!\nonamecrackers2\witherstormmod\common\config\WitherStormModConfig.class
