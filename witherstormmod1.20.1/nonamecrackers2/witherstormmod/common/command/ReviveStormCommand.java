...
/* 36 */     int timeSincePlayingDead = 0;
/* 37 */     if (entity != null)
/*    */     {
/* 39 */       if (entity instanceof WitherStormEntity) {
/*    */         
/* 41 */         WitherStormEntity storm = (WitherStormEntity)entity;
/* 42 */         timeSincePlayingDead = storm.getPlayDeadManager().getTicksSinceRevival();
/* 43 */         if (storm.getPlayDeadManager().getState().disablesAi())
/*    */         {
/* 45 */           storm.reviveFromPlayingDead();
/* 46 */           MutableComponent component = Component.m_237110_("commands.witherstormmod.reviveStorm.success", new Object[] { storm.m_5446_() });
/* 47 */           source.m_288197_(() -> component, true);
/*    */         }
/*    */         else
/*    */         {
/* 51 */           MutableComponent component = Component.m_237110_("commands.witherstormmod.reviveStorm.failure", new Object[] { storm.m_5446_() });
...
/*    */       } 
/*    */     }
/* 61 */     return timeSincePlayingDead;
/*    */   }
/*    */ }


/* Location:              C:\Users\Jackbot\Desktop\Jacks Crackers Wither Storm Update\witherstormmod-1.20.1-4.2.1-all.jar!\nonamecrackers2\witherstormmod\common\command\ReviveStormCommand.class
